            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/murids/update_profile/<?= $murid['id'] ?>" method="POST">
                            <?= csrf_field() ?>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nomor Induk</label>
                                    <div class="col-sm-10">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label"><?= $murid['no_induk'] ?></label>
                                        <input type="hidden" class="form-control" id="inputEmail3" placeholder="ID Murid" name="no_induk" value="<?= $murid['no_induk'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label"><?= $murid['kelas'] ?></label>
                                        <input type="hidden" class="form-control" id="inputEmail3" name="kelas" value="<?= $murid['kelas'] ?>">
