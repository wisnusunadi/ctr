            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/guru/update/<?= $guru['id'] ?>" method="POST">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nomor Induk</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" placeholder="ID Guru" name="no_induk" value="<?= $guru['no_induk'] ?>">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Nama Guru" name="nama" value="<?= $guru['nama'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Tgl Lahir</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="inputPassword3" placeholder="Password" name="tgl_lahir" value="<?= $guru['tgl_lahir'] ?>">
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-2 col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="jenis" value="l" <?= $guru['jenis'] == 'l' ? "checked" : "" ?>>
                                            <label class="form-check-label" for="exampleCheck2">Laki Laki</label>
                                        </div>
                                    </div>
                                    <div class="offset-sm-2 col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="jenis" value="p" <?= $guru['jenis'] == 'p' ? "checked" : "" ?>>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="select2 form-control" id="inputPassword3" placeholder="Password" name="mata_pelajaran_id">
                                            <?php foreach ($mapel as $m) : ?>
                                                <option value="<?= $m['id'] ?>" <?= $m['id'] ==  $guru['mata_pelajaran_id'] ? 'selected' : ''  ?>> <?= $m['nama'] ?> - Kelas <?= $m['kelas'] ?> </option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
