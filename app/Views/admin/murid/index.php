                ...
                <div class="col-8">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-6">
                                    <a type="button" class="btn btn-info" href="/murids/create">
                        ...
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($murid as $k) : ?>
                                        <tr>
                                            ...
                                            <td>Kelas <?= $k['kelas']; ?></td>
                                            <td>
                                                <a type="button" class="btn btn-info" href="/murids/edit/<?= $k['id']; ?>">
                                                    <i class="fas fa-pencil-alt"></i>&nbsp;Edit
                                                </a>
                                                &nbsp;
                                                <form action="/murids/delete/<?= $k['id']; ?>" class="d-inline" method="post">
                                                    <?= csrf_field() ?>
                            ...
                            <?= $pager->links('murid', 'custom_pagination'); ?>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
