            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/murids" method="POST">
                            <?= csrf_field() ?>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nomor Induk</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" placeholder="ID Murid" name="no_induk">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Nama Murid" name="nama">
                                    </div>
                                </div>
                                <div class="form-group row">
